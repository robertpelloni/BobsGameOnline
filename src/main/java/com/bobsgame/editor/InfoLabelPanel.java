...
{//===============================================================================================
	...
	{//===============================================================================================
		...
		if(E!=null)
		{
			...
			if(E.statsLabel!=null)E.statsLabel.setText("Zoom: "+(MapCanvas.zoom/8.0f)*100+"% | Used: "+usedMemory+" MB | Free: "+rt.freeMemory()/mb+" MB | Total: "+ rt.totalMemory()/mb + " MB | Max: " + rt.maxMemory()/mb+" MB");

			if(E.infoLabelPanel!=null)E.infoLabelPanel.validate();
		}
	}
