...
{//=========================================================================================================================
	...
	private static HashMap<String,Integer> loadedSoundHashMap=new HashMap<String,Integer>();
	...
	{//=========================================================================================================================
		...
		for(int i=0;i<channelInUse.length;i++)channelInUse[i]=false;
	...
	{//=========================================================================================================================
		...
		AL10.alSourcef(getChannelFromIndex(channelIndex),AL10.AL_GAIN,(float)volume);
	}
	...
	{//=========================================================================================================================
		...
		AL10.alSourcef(getChannelFromIndex(channelIndex),AL10.AL_PITCH,(float)pitch);
	}
	...
	{//=========================================================================================================================
		...
		AL10.alSourcef(AudioUtils.getChannelFromIndex(channelIndex),AL11.AL_SEC_OFFSET,(float)position);
	...
	{//=========================================================================================================================
		...
		AL10.alSourcef(getChannelFromIndex(openChannelIndex),AL10.AL_PITCH,(float)pitch);
		AL10.alSourcef(getChannelFromIndex(openChannelIndex),AL10.AL_GAIN,(float)gain);
		...
		sourcePos.put(new float[]{(float)x,(float)y,(float)z});
		sourcePos.flip();
		sourceVel.flip();
	...
	//=========================================================================================================================
	public static AudioChannel getOggStreamAudioChannel(URL fileURL) throws IOException
	{//=========================================================================================================================
